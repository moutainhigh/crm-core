...
/**
 * Created by Sasha ins on 20.04.2017.
 */
@Controller
public class MenuBossContoller {
	...
	public ModelAndView getAdminPagePost(ModelAndView modelAndView,
	...
	public ModelAndView updProduct(@RequestParam(name = "upd") Long id,
	...
	public ModelAndView addProd(@RequestParam(name = "add") Long id,
								@RequestParam(name = "name") String name,
								@RequestParam(name = "cost") Double cost,
								@RequestParam(name = "des") String des) {
		Category category = categoriesService.getOne(id);
