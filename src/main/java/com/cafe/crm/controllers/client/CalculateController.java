...
public class CalculateController {
	...
	public String addCalculate(@RequestParam(name = "boardId") Long id,
		...
		calculateControllerService.addCalculate(id, number, description);
		return "redirect:/manager";
	}

	@RequestMapping(value = {"/refresh-board"}, method = RequestMethod.POST) // German, refresh board. See in HTML code, file client.html
