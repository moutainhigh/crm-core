...
public class InitTemplate {
	...
	public void init() throws IOException {
		...
		initCompany.setId(1L);
		disable.setCompany(initCompany);
		...
		balanceAfterDeduction.setCompany(initCompany);
		...
		balanceAfterRefill.setCompany(initCompany);
		...
		invalidToken.setCompany(initCompany);
		...
		exampleCloseShift.setCompany(initCompany);
