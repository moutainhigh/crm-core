...
public class ShiftCalculationServiceImpl implements ShiftCalculationService {
	...
	public TotalStatisticView createTotalStatisticView(LocalDate from, LocalDate to) {
		...
		profit = getProfit(clientsOnDetails, givenDebts, repaidDebt);
	...
	private double getProfit(Map<Client, ClientDetails> clientsOnDetails, List<Debt> givenDebts, List<Debt> repaidDebt) {
		double profit = 0D;
