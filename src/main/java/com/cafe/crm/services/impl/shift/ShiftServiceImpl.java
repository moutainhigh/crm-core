...
public class ShiftServiceImpl implements ShiftService {
    ...
    @Override
    public void closeShift(Double totalCashBox, Map<Long, Long> workerIdBonusMap, Double allPrice, Double shortage, Double bankKart) {
        GoodsCategory goodsCategory = goodsCategoryService.findByNameIgnoreCase("Зарплата сотрудников");
        // TODO: 18.07.2017 Исправить захардкодженную инициалцию
        if (goodsCategory == null) {
            goodsCategory = new GoodsCategory("Зарплата сотрудников");
